...
'        Me.BackColor = Color.FromArgb(240, 244, 248)  ' ✅ Light gray-blue background
'    End Sub

'    ' ================= STYLE CARDS =================
'    Private Sub StyleCards()

'        ' ✅ Welcome Labels - fix color so it shows properly
'        lblWelcome.Font = New Font("Segoe UI", 20, FontStyle.Bold)
'        lblWelcome.ForeColor = Color.FromArgb(30, 30, 30)  ' ✅ Dark color so visible
...
'        ' ✅ Last Purchase Card - Orange
'        pnlLastPurchase.BackColor = Color.FromArgb(231, 76, 60)
'        pnlLastPurchase.Size = New Size(220, 130)
'        lblLastTitle.ForeColor = Color.FromArgb(255, 220, 210)
'        lblLastTitle.Font = New Font("Segoe UI", 11, FontStyle.Bold)
'        lblLastTitle.TextAlign = ContentAlignment.MiddleCenter
'        lblLastTitle.Dock = DockStyle.Top
'        lblLastTitle.Height = 35
'        lblLastTitle.BackColor = Color.Transparent
'        lblLastDate.ForeColor = Color.White
'        lblLastDate.Font = New Font("Segoe UI", 16, FontStyle.Bold)
...
'            Dim totalOrders As Integer = Convert.ToInt32(ordersCmd.ExecuteScalar())
