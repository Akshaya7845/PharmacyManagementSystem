...
'    ' ================= GLOBAL VARIABLES =================
'    Public currentUserID As Integer = 0   ' ✅ receives from CartForm
'    Public currentUserName As String = "" ' ✅ receives from CartForm
...
'            da.SelectCommand.Parameters.AddWithValue("@uid", currentUserID) ' ✅ real UserID
...
'                MessageBox.Show("Bill Generated! Bill ID: " & billID, "Bill", MessageBoxButtons.OK, MessageBoxIcon.Information)
...
'            ' ✅ Refresh bill UI (will show empty after cart cleared)
'            LoadBill()
'        End If
'    End Sub
...
'        billCmd.Parameters.AddWithValue("@total", Convert.ToDecimal(lblTotal.Text.Replace("₹", "")))
...
'        payCmd.Parameters.AddWithValue("@amt", Convert.ToDecimal(lblTotal.Text.Replace("₹", "")))
...
'        ' ✅ Title
'        e.Graphics.DrawString("PHARMACY BILL", titleFont, Brushes.Black, 200, y)
'        y += 40

'        ' ✅ Customer Info
'        e.Graphics.DrawString(lblUserID.Text, textFont, Brushes.Black, 50, y)
'        y += 20
'        e.Graphics.DrawString(lblUserName.Text, textFont, Brushes.Black, 50, y)
'        y += 20
'        e.Graphics.DrawString(lblDate.Text, textFont, Brushes.Black, 50, y)
'        y += 20
'        e.Graphics.DrawString(lblPaymentMethod.Text, textFont, Brushes.Black, 50, y)
'        y += 30

'        ' ✅ Table Headers
'        e.Graphics.DrawString("Medicine", headerFont, Brushes.Black, 50, y)
'        e.Graphics.DrawString("Price", headerFont, Brushes.Black, 220, y)
'        e.Graphics.DrawString("Qty", headerFont, Brushes.Black, 320, y)
'        e.Graphics.DrawString("Total", headerFont, Brushes.Black, 400, y)
'        y += 20
...
'            e.Graphics.DrawString("₹" & row("Price").ToString(), textFont, Brushes.Black, 220, y)
'            e.Graphics.DrawString(row("Quantity").ToString(), textFont, Brushes.Black, 320, y)
'            e.Graphics.DrawString("₹" & row("Total").ToString(), textFont, Brushes.Black, 400, y)
'            y += 20
'        Next
...
'        ' ✅ Grand Total
'        e.Graphics.DrawString("Total Amount: " & lblTotal.Text, titleFont, Brushes.Black, 250, y)
'    End Sub
